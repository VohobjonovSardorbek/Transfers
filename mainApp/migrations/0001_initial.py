    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_tft', models.FloatField(blank=True, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('datetime', models.DateTimeField(blank=True, null=True)),
                ('club_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='club_from_set', to='mainApp.club')),
                ('club_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='club_to_set', to='mainApp.club')),
